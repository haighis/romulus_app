defmodule RomulusWeb.SessionControllerTest do
  @moduledoc false
  use RomulusWeb.ConnCase
  ...
  def fixture(:user) do
    {:ok, user} = Romulus.Accounts.Auth.register(@user_default_attrs)
    user
  end

  def secure_conn(conn) do
    user = fixture(:user)
    {:ok, jwt, _} = user |> RomulusWeb.Guardian.encode_and_sign(%{}, token_type: :token)
